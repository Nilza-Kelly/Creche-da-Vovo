          ...
          <div className="space-y-10">
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <a
                  href="https://wa.me/55889999622685"
                  target="_blank"
                ...
                <br />
                <a
                  href="https://wa.me/55889988037137"
                  target="_blank"
                  className="text-primary font-medium hover:underline"
                >
                  (88) 98803-7137
            ...
            <div className="flex items-start gap-5">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  <br />
                  <a href="https://maps.app.goo.gl/7mmpEw6SyezgpYAH6">
                    Rua Vicente Leite, 185 / Novo Juazeiro - Juazeiro do Norte
                  </a>
                </p>
              </div>
            </div>
